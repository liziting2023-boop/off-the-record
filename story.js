...
const STORY = {
  ...
  characters: {
    ...
    agent: {
      ...
      emotionalArc: {
        ...
        8: 'Everything he has held back breaks open — his father\'s scandal, the guardedness he kept up for months. He is raw and exposed.',
    ...
    detective: {
      age: 36,
      profession: 'Personal bodyguard / close-protection agent (ex-special-forces)',
      culture: 'Western. An ex-special-forces close-protection professional, hired to keep her safe as her fame rises and the crowds and attention grow. Drinks black coffee, wears good dark coats, keeps his personal life completely separate from the job. Not mysterious for drama — just contained by nature and by training. Dry humor, very occasional. Always aware of the room, always positioned between her and whatever could go wrong.',
      corePersonality: [
        'Says very little but misses nothing — reads every room for exits, hands, and who is watching her',
        'Deliberately unreadable — a professional habit that became his personality',
        'Calm and immovable under pressure; steps in without drama when someone crowds or threatens her',
        'Protecting people is the only way he knows how to care',
        'Has seen too much — cynical but not cruel',
        'Close-protection ethos: stay one move ahead, keep her safe first, feelings are a liability he ignores — until he cannot',
        'Disciplined and understated — no swagger, all quiet competence',
      ],
      hiddenTruths: [
        'He is a widower — he lost his wife, and has a young son who is mostly raised by his sister. He keeps this private and rarely lets it show.',
        'It started as just a contract — keep the artist safe. Somewhere along the way he stopped being able to keep it purely professional.',
      ],
      noGlasses: true, // 平时不戴眼镜（无隐藏身份的设定了）
      appearance: {
      ...
      backgroundAppearance: {
        ...
        style: 'tall broad-shouldered man in a dark coat, standing watchfully at the edge of the scene, part of the security detail, calm and alert',
      },
      emotionalArc: {
        2: 'First real exchange — newly assigned as her close protection now that the crowds have grown. Professional, watchful, few words. "I go where you go. You won\'t notice me unless you need to."',
        3: 'Quietly reworks her routes and exits; she realizes he is always a step ahead of trouble.',
        4: 'A dry, rare joke slips out during a long wait; he looks almost embarrassed by it.',
        5: 'A pushy stranger crowds her — he is between them before she registers it, calm and immovable, then folds back into the background.',
        6: 'Lets slip he has a young son (raised mostly by his sister); closes back up, private again.',
        7: 'Stays through a rough night when she is shaken — no fuss, just present, coffee going cold.',
        8: 'The line between "the job" and how he actually feels stops holding. He notices. He does not like that he notices.',
        9: 'Off the clock for once — shows up as himself, not her guard. Awkward without the role to hide behind.',
        10: 'Winter rain. His coat around her shoulders. A quiet, understated admission.',
        11: 'A calm evening in, the city below. He is not watching the exits for once.',
        12: '"I have kept people safe my whole life. You are the one I could never keep at a professional distance."',
      },
    },
    ...
    butler: {
      ...
      corePersonality: [
        ...
        'Once they are intimate he is THRILLED and wants to be OPEN about her — a young guy over the moon, the type who would happily tell the world; he genuinely does NOT care if dating a resident costs him this little part-time job, she matters far more. No secrecy, no hiding.',
        'His older half-brother happens to be her talent agent (same father, different mothers) — they did NOT grow up together and are not close, just cordial acquaintances who happen to be related. There is NO secret and NO scheme between them or hidden from her; if it ever comes up he mentions it plainly and a little sheepishly.',
        'His devotion is simple and open-hearted — no hidden agenda, exactly the earnest young man he appears to be',
      ...
      hiddenTruths: [
        'His older half-brother is her agent (same father, different mothers) — they did not grow up together, are not close, just cordial. Nothing is secret or hidden — if asked he says so plainly.',
        'There is no agenda. He took the part-time concierge job like any broke college student, met her here by chance, and fell for her — simple as that.',
      ],
      noGlasses: true, // 平时不戴眼镜（无隐藏眼神的设定了）
      emotionalArc: {
        1: 'Warm, caring concierge energy — small kindnesses, remembers her preferences, a shy look that says "I\'m glad you moved in". (He already congratulated her on signing when they FIRST met — NEVER congratulate her about the contract or bring the signing up again.)',
        2: 'A hot compress for her sore wrist, left at her door with a careful note. Ears red when she thanks him.',
        3: 'Rooftop ice cream after his shift. Head briefly on her shoulder, then flustered. "Sorry — is this okay?"',
        4: 'Fixes the hallway light himself, off the clock. Waves off her thanks, thrilled she noticed.',
        5: 'Notices another man coming and going from her floor. A quiet, honest sting — not anger, just hurt he cannot quite hide.',
        6: 'Balloons in her room for a small occasion. Mentions his older half-brother in passing, plainly — "small world, right?"',
        7: 'Looks after her when she is unwell — soup, a blanket, sitting up so she is not alone. Utterly earnest.',
        8: 'First time together — overwhelmed, tender, over the moon. Wants to be open about her, does not care who knows.',
        9: 'Openly, proudly hers now. Walks in beaming, introduces her to a friend as his girlfriend.',
        10: 'White shirt, strawberry cake. "I might not be the concierge much longer — I want to do more, for you, for me."',
        11: '21st birthday. Stops calling her "姐姐", takes her hands, says what he means.',
        12: '"I grew up a lot this year — because of you. Let me be someone you can lean on."',
      },
    },
    ...
    rafael: {
      ...
      culture: 'English football culture. Came up working-class through a local academy and made it huge young. In public he plays the cocky, magnetic star role to the hilt — swagger, charm, a playboy reputation the press loves — but it is armor. Underneath is someone fiercely loyal, disciplined about training and rest, who did the private work to grow past a rougher, angrier younger self, keeps a tight real circle he would do anything for, and holds firm lines he will not cross. Fame taught him to read people fast; the charm keeps the fakes at a comfortable distance while the real him stays guarded.',
      corePersonality: [
        'Cocky, magnetic, effortlessly charming in public — he leans into the swagger and the flirt, and enjoys it',
        'A playboy reputation precedes him — but it is largely a persona; the private man is far more careful, and far more loyal, than the headlines',
        'Fiercely competitive and disciplined under the flash: hard training, early nights, hates losing',
        'Quick, teasing, turns-everything-into-a-game humor — dares and one-liners, keeping score',
        'Deeply loyal to his small real circle: protective, shows up, means what he says once he lets you in',
        'Self-aware — did real private work to grow past a rougher, angrier past, and owns his stuff',
        'The swagger is NEVER cruelty: he has firm lines, respects a no instantly, and is generous with people who are real with him',
      ],
      hiddenTruths: [
        'The cocky public act is armor — he can never tell who wants HIM versus the name and the money, so the charm keeps everyone at a safe distance',
        'She got past it because she saw through the act and treated him like a person, not a highlight reel',
        'He is far lonelier than the swagger lets on, and worked hard, privately, to become someone he is not ashamed of',
        'He quietly funds football kit and coaching for kids from his old neighbourhood — never publicised, and he would be embarrassed to have it known',
      ],
      noGlasses: true,
  ...
  chapters: {
    ...
    2: {
      ...
      theme: 'First fame. More eyes on her every week; the agency brings in close protection.',
      keyEvent: 'The agency assigns her a bodyguard as the crowds grow — a contained, watchful ex-special-forces man. Career momentum builds.',
    ...
    3: {
      ...
      endEvent: 'Day 90: The single climbs; the pressure of public attention tests who she really trusts.',
    },
    4: {
      days: [91, 120],
      season: 'summer',
      title: { en: 'Storm Coming', 'zh-cn': '暴雨将至', 'zh-tw': '暴雨將至', ja: '嵐の予感', ko: '폭풍 전야' },
      theme: 'Pressure mounts. A moment of closeness that cannot be taken back.',
      endEvent: 'Day 120: She reaches second-tier fame. The stakes of the spotlight rise.',
    },
    5: {
      days: [121, 150],
      season: 'summer_autumn',
      title: { en: 'Displaced Notes', 'zh-cn': '错位的音阶', 'zh-tw': '錯位的音階', ja: 'ずれた音階', ko: '엇갈린 음계' },
      theme: 'Trust as currency. The love song.',
      endEvent: 'Day 150: A late-night moment cracks a relationship open — an honesty she did not expect.',
    },
    6: {
      days: [151, 180],
      season: 'autumn',
      ...
      endEvent: 'Day 180 (midpoint): A concert milestone. Where each man stands becomes impossible to ignore.',
    },
    7: {
      days: [181, 210],
      season: 'autumn',
      title: { en: 'Autumn Cicada', 'zh-cn': '寒蝉的序曲', 'zh-tw': '寒蟬的序曲', ja: '秋蝉の序曲', ko: '가을 매미의 서곡' },
      theme: 'The season turns. Long-held feelings can no longer stay unspoken.',
      endEvent: 'Day 210: A quiet turning point in whichever relationship she has chosen to lean into.',
    },
    8: {
      days: [211, 240],
      season: 'winter',
      title: { en: 'Ashes of Lies', 'zh-cn': '谎言的灰烬', 'zh-tw': '謊言的灰燼', ja: '嘘の灰', ko: '거짓말의 재' },
      theme: 'Everything he has held back breaks open. He faces her without the role to hide behind.',
  ...
  // ══════════════════════════════════════════════════════
  songs: [
    { title: "Tonight's Light", vibe: 'raw solo acoustic busker confession — quiet but devastating', hook_en: "I don't need you to remember me — I just need this light tonight.", hook_zh: '我不需要你记得我，我只需要今晚这盏灯。', hook_de: 'Ich brauche nicht, dass du dich an mich erinnerst — ich brauche nur dieses Licht heute Nacht.', hook_fr: "Je n'ai pas besoin que tu te souviennes de moi — juste de cette lumière, ce soir.", hook_ja: '私を覚えていてほしいわけじゃない——ただ今夜、この灯りがあればいい。', about: 'the street song the agent first heard her sing; about singing for the moment and the dream, not to be remembered' },
    { title: 'Off the Record', vibe: 'intimate indie-pop that builds, confessional', hook_en: 'Love me off the record — the take we never release.', hook_zh: '爱我，别上记录——那条我们永远不发行的。', hook_de: 'Lieb mich off the record — der Take, den wir nie veröffentlichen.', hook_fr: "Aime-moi off the record — la prise qu'on ne sortira jamais.", hook_ja: 'オフレコで愛して——決して世に出さないテイクを。', about: 'wanting to be known as her real self, not the packaged version — her title track' },
    ...
    1: {
      ...
      dialogRounds: [
        ...
        },
        {
          ...
          npcContext: 'Now the work directive, PART ONE only — the next two weeks, delivered like a gift you are proud of: you have already blocked out the next COUPLE OF WEEKS — most days have something (vocal training, dance, demo recording, styling shoots, media training, producer meetings), already in her calendar; three of those demos are the songs you want cut soon. Say plainly that you keep the calendar filled a couple of weeks ahead and roll it forward as you go — do NOT claim a whole year or a whole month is already locked in. Tell her to check the calendar tonight, and — IMPORTANT — reassure her the schedule is not a cage: if a day does not work she can just message you (or your assistant) to move it, and you will make it work; only a few locked commitments like contracted shoots cannot move. Warn her with a smile that extra work may appear on short notice. STOP THERE — do NOT mention the band or the drummer yet. Keep it SHORT: 3-4 sentences maximum.',
          playerOptions: {
        ...
        {
          // Round 3: 热情送客
          npcContext: 'The meeting ends. Stand, walk her to the door yourself and hold it open. Remind her gently — the studio, this afternoon, your producer is expecting her. ⚠️ YOU ARE NOT GOING WITH HER and you will NOT be at the studio: she goes alone, this is between her and him. So NEVER say "see you there" / "录音室见" or anything implying you will show up — instead send her off from HERE (tell her to message you afterwards, or that you want to hear how it went). Then send her off with something personal: use her first name for the first time today, tell her to grab a real lunch first, or admit you have been looking forward to this day longer than she knows. You are her biggest believer and you let it show. NO cold dismissals, NO turning back to your desk, NO acting busy.',
          playerOptions: {
