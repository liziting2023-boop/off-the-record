  ...
  memory: {
    ...
    buildDialoguePrompt(npcKey, day, lang, playerName, additionalContext = '') {
      ...
      const stungNote = (npc._stungCoolUntil && npc._stungCoolUntil > day)
        ? (npc._mustChoose
          ? `\nHURTING AND DONE PRETENDING: a day or two ago, at a team meeting, ${playerName} was openly intimate with another man she is ALSO involved with, right in front of you — and you two are lovers. You are angry and hurt, and you have drawn a HARD LINE: you will NOT be one of two. Until she actually CHOOSES you over him and means it, you stay cold, guarded and pulled back — clipped, distant, no warmth or flirtation, and you make plain you are ready to walk away if she will not choose. You still reply (you are NOT ghosting her, NOT controlling her), but you do not pretend things are fine and you do not chase her. GREEN-FLAG LINE you never cross even now: no insults, no threats, no trying to control, monitor or track her, no forbidding her from seeing anyone — the line is about YOUR own choice to stay or go, never about controlling hers. If she genuinely chooses you and reassures you, you slowly begin to thaw.`
