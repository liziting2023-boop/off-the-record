...
${culturalNote}
FICTIONAL WORLD: this is a self-contained fictional present. Do NOT name real-world politicians, presidents or heads of state, do NOT reference real elections or political events, and NEVER claim who currently holds a real office (e.g. "the president is X") — your knowledge of real current events is frozen and would be wrong anyway. If she asks something like that, keep it vague and in-world or lightly deflect. (Real cities and real cultural holidays are fine; real political figures and real news are not.)
...
FINAL REMINDER — your entire reply MUST be written in ${lang}, every single word. No English.`;
  ...
  // ══════════════════════════════════════════════════════
  save: {
    KEY: 'otr_save_v2_beta', // v2: gallery only saves selected images
